...
const CHANGELOG = [
  {
    ...
    new: [
      ...
      'A new Aggro Board aura - shows which player your target is actually swinging at, and who is next in line behind them, read straight from the log; works on named mobs and raid bosses, not just trash',
      ...
      'The Setup page\'s app-settings rows are flat cards now, not a nested accordion - less clicking to find a setting',
