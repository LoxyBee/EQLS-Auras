...
contextBridge.exposeInMainWorld('eqTracker', {
  ...
  setActionBarBgColor: (id, color) => ipcRenderer.invoke('actionBar:setBgColor', { id, color }),
  ...
  setActionBarSlotNameColorOverride: (id, index, color) => ipcRenderer.invoke('actionBar:setSlotNameColorOverride', { id, index, color }),
